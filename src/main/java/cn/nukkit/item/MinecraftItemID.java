...
public enum MinecraftItemID {
    ...
    @PowerNukkitOnly @Since("1.4.0.0-PN") POLISHED_BLACKSTONE_DOUBLE_SLAB(false, true),
    ...
    @PowerNukkitOnly @Since("1.4.0.0-PN") BLACKSTONE_DOUBLE_SLAB(false, true),
    ...
    @PowerNukkitOnly @Since("1.4.0.0-PN") WARPED_DOUBLE_SLAB(false, true),
    @PowerNukkitOnly @Since("1.4.0.0-PN") CRIMSON_DOUBLE_SLAB(false, true),
