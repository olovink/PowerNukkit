...
public abstract class Entity extends Location implements Metadatable {
    ...
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_IS_TRANSFORMING = dynamic(55);
    ...
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_RIDER_CAN_PICK = dynamic(61);
    @PowerNukkitOnly @Since("1.2.0.0-PN") public static final int DATA_FLAG_TRANSITION_SITTING = dynamic(62); // PowerNukkit but without typo
    ...
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_TRANSITION_BLOCKING = dynamic(73);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_BLOCKED_USING_SHIELD = dynamic(74);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_BLOCKED_USING_DAMAGED_SHIELD = dynamic(75);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_SLEEPING = dynamic(76);
    @Since("1.6.0.0-PN") public static final int DATA_FLAG_ENTITY_GROW_UP = dynamic(77);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_TRADE_INTEREST = dynamic(78);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_DOOR_BREAKER = dynamic(79);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_BREAKING_OBSTRUCTION = dynamic(80);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_DOOR_OPENER = dynamic(81);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_IS_ILLAGER_CAPTAIN = dynamic(82);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_STUNNED = dynamic(83);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_ROARING = dynamic(84);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_DELAYED_ATTACK = dynamic(85);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_IS_AVOIDING_MOBS = dynamic(86);
    @Since("1.3.0.0-PN") public static final int DATA_FLAG_IS_AVOIDING_BLOCKS = dynamic(87);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_FACING_TARGET_TO_RANGE_ATTACK = dynamic(88);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_HIDDEN_WHEN_INVISIBLE = dynamic(89);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_IS_IN_UI = dynamic(90);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_STALKING = dynamic(91);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_EMOTING = dynamic(92);
    @Since("1.2.0.0-PN") public static final int DATA_FLAG_CELEBRATING = dynamic(93);
    @Since("1.3.0.0-PN") public static final int DATA_FLAG_ADMIRING = dynamic(94);
    @Since("1.3.0.0-PN") public static final int DATA_FLAG_CELEBRATING_SPECIAL = dynamic(95);
    public static final int DATA_FLAG_OUT_OF_CONTROL = dynamic(96);
    @Since("1.4.0.0-PN") public static final int DATA_FLAG_RAM_ATTACK = dynamic(97);
    @Since("1.5.0.0-PN") public static final int DATA_FLAG_PLAYING_DEAD = dynamic(98);
    @Since("1.6.0.0-PN") public static final int DATA_FLAG_IN_ASCENDABLE_BLOCK = dynamic(99);
    @Since("1.6.0.0-PN") public static final int DATA_FLAG_OVER_DESCENDABLE_BLOCK = dynamic(100);
